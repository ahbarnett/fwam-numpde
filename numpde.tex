...
We just saw algebraic conv.\ error $=\bigO(N^{-k})$, for order $k=1,2$
...
% ---------------------------------------------------
\begin{frame}\ft{Higher algebraic order interpolation}

  local Lagrange: arb. high ord, but formally discont.

  usually not a problem.

  barycentric

pointer to: splines (if you {\em must} have higher-order continuity
  
\end{frame}

% ---------------------------------------------------
\begin{frame}\ft{First spectral method: periodic $f$}
