...
%
\begin{equation}
	\int \psi_m \nabla \cdot \mbf{j} \,d\mbf{x} = \int \mbf{n} \cdot \mbf{j} \,dS
\end{equation}

\gb Requires integrating fluxes at cell interfaces
...
\gb Use piecewise linear ``tent'' functions. \com{Continuous}
...
\gb No exact conservation... but very high accuracy. \com{Good diagnostics!}
